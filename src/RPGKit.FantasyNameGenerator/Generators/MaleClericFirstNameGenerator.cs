namespace RPGKit.FantasyNameGenerator
{
	...
	public class MaleClericFirstNameGenerator : NameGenerator, INameGenerator
	{
		...
		public static string[] Cleric_FirstNamesPart1 = new string[] { "Strum", "Halo", "Car", "Heva", "Men", "Gre" };
		public static string[] Cleric_FirstNamesPart2 = new string[] { "bright", "gold", "burnd", "del", "gor" };
